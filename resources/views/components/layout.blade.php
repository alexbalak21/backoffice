    ...
    <div class="d-flex">
        <aside class="expand">
            ...
            <ul class="sidebar-nav">
                ...
                <li class="sidebar-item">
                    <a href="{{ route('echantillon-analyses.analysis-table') }}" class="sidebar-link {{ Request::is('echantillon-analyses/analysis-table*') ? 'active' : '' }}"><i class="fa-solid fa-table"></i><span>Analysis Table</span></a>
                </li>
                <li class="sidebar-item">
